...
var G__27678 = o;
goog.object.set(G__27678,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__27682 = o;
goog.object.set(G__27682,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__27686 = props;
var G__27686__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27686,cljs.core.cst$kw$id,id):G__27686);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27686__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27687 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27687,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27687;
}
})(),id_class);
...
var G__27688 = (cljs.core.count(argv) - first_child);
switch (G__27688) {
case (0):
...
break;
case (1):
var G__27689 = component;
var G__27690 = jsprops;
var G__27691 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__27689,G__27690,G__27691);
...
var vec__27693 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27693,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27693,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27693,(2),null);
...
var temp__5757__auto___27696 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___27696 == null)){
} else {
var key_27697 = temp__5757__auto___27696;
...
var temp__5757__auto___27700 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___27700 == null)){
} else {
var key_27701 = temp__5757__auto___27700;
(jsprops.key = key_27701);
}

var G__27698 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__27699 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__27698,G__27699);
});
/**
...
var temp__5757__auto___27702 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___27702 == null)){
} else {
var key_27703 = temp__5757__auto___27702;
(jsprops.key = key_27703);
}
...
var temp__5757__auto___27704 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27704 == null)){
} else {
var key_27705 = temp__5757__auto___27704;
(jsprops.key = key_27705);
}
...
var temp__5757__auto___27706 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27706 == null)){
} else {
var key_27707 = temp__5757__auto___27706;
(jsprops.key = key_27707);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27708_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27708_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27709 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27709,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27709,(1),null);
...
break;
default:
var G__27714 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27715 = compiler;
v = G__27714;
compiler = G__27715;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27719 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27719 = (function (opts,id,fn_to_element,parse_fn,meta27720){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta27720 = meta27720;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template27719.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27721,meta27720__$1){
var self__ = this;
var _27721__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27719(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta27720__$1));
}));

(reagent.impl.template.t_reagent$impl$template27719.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27721){
var self__ = this;
var _27721__$1 = this;
return self__.meta27720;
}));

(reagent.impl.template.t_reagent$impl$template27719.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27719.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27719.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template27719.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27719.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27719.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta27720], null);
}));

(reagent.impl.template.t_reagent$impl$template27719.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27719.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27719");

(reagent.impl.template.t_reagent$impl$template27719.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template27719");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27719.
 */
reagent.impl.template.__GT_t_reagent$impl$template27719 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27719(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27720){
return (new reagent.impl.template.t_reagent$impl$template27719(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27720));
});

}

return (new reagent.impl.template.t_reagent$impl$template27719(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
